### Attempt to fix compilation of '74 - '89 data: ran with OLD comtrs data generated July 17 
...
def read_data(year):
    if year < 1990:
        ...
        # directory = 
        tlb_overall_data = pd.read_csv(os.path.join(directory, str('comtrs_pur_vals_year' + str(year_two_digits) + '.csv') ) )
...
def calculate_acres_pre_1990(year, crop_type, crop_iter, crop_list, tlb_overall_data): # for a given set of comtrs, calculate total tree crop acreage 
    ...
    if save_crop_file == 1:
        ...
        if os.path.isdir("/Users/nataliemall/Box Sync/herman_research_box/calPIP_PUR_crop_acreages_aug_15"):
            print('folder does exist')
        else:
            os.mkdir('/Users/nataliemall/Box Sync/herman_research_box/calPIP_PUR_crop_acreages_aug_15')
    ...
    try:
        ...
        if save_acres == 1:
            ...
            directory=os.path.join('/Users/nataliemall/Box Sync/herman_research_box/calPIP_PUR_crop_acreages_aug_15', year_two_digits + 'files' )
            # try: 
...
def retrieve_data_for_irrigation_district(irrigation_district):
    ...
    codes_pre_1990 = pd.read_csv('~/Box Sync/herman_research_box/calPIP_PUR_crop_acreages_aug_15/site_codes_with_crop_types.csv', usecols = ['site_code_pre_1990', 'site_name_pre_1990', 'is_orchard_crop_pre_1990', 'is_annual_crop_pre_1990']) # , index_col = 0)
    codes_1990_2016 = pd.read_csv('~/Box Sync/herman_research_box/calPIP_PUR_crop_acreages_aug_15/site_codes_with_crop_types.csv', usecols = ['site_code_1990_2016', 'site_name_1990_2016', 'is_orchard_crop_1990_2016', 'is_annual_crop_1990_2016']) #, index_col = 0)
...
# using old data created July 17: 
